          ...
          <div className="relative w-full h-[500px] md:h-[600px] overflow-hidden animate-pulse">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent p-4">
                {/* 아티스트명 스켈레톤 */}
                <div className="h-8 md:h-10 bg-gray-300 rounded opacity-60 mb-2 w-48"></div>

                {/* 장르 태그 스켈레톤 */}
                <div className="flex gap-2">
                  <div className="h-6 bg-gray-300 rounded-full opacity-50 w-16"></div>
                  <div className="h-6 bg-gray-300 rounded-full opacity-50 w-20"></div>
                </div>
              </div>
            </div>
          </div>
